# AutomaLead Backend — Trademark and Brand Assets Policy
...
This policy governs the use of AutomaLead Backend trademarks and brand assets.
...
2.1. You may truthfully refer to AutomaLead Backend to describe that your software
...
AutomaLead Backend that include AutomaLead Backend brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use AutomaLead Backend marks in nominative ways, such as
"based on AutomaLead Backend", provided that the use is accurate and does not
create confusion.
...
AutomaLead Backend brand assets.** If you distribute or publicly host any version
of the user interface that uses AutomaLead Backend brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove AutomaLead Backend brand assets.**
...
(a) remove and replace all AutomaLead Backend trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from AutomaLead Backend.
...
AutomaLead Backend logo or wordmark.
...
Any violation of this policy terminates your permission to use AutomaLead Backend
brand assets. You must promptly cease use and remove AutomaLead Backend trademarks
