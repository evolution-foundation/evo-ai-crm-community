class Api::V1::AgentBotsController < Api::V1::BaseController
  ...
  # ⚠️ `:api_key` foi readicionado para retrocompatibilidade com o provisionamento automático
  # de agentes, até que a API de Vault esteja disponível.
  def permitted_params
    params.permit(
      :name, :description, :outgoing_url, :avatar, :avatar_url, :bot_type, :bot_provider, :credential_id, :api_key, :message_signature,
